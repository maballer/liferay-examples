...
/**
 * Provides the local service interface for Rol. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author maballe
 * @see RolLocalServiceUtil
...
public interface RolLocalService extends BaseLocalService, InvokableLocalService,
    PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link RolLocalServiceUtil} to access the rol local service. Add custom service methods to {@link ec.com.smx.portal.rrhh.services.service.impl.RolLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
