...
/**
 * Provides the local service interface for UsuarioRol. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author maballe
 * @see UsuarioRolLocalServiceUtil
...
public interface UsuarioRolLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link UsuarioRolLocalServiceUtil} to access the usuario rol local service. Add custom service methods to {@link ec.com.smx.portal.rrhh.services.service.impl.UsuarioRolLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
